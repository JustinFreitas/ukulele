...
dependencies {
    ...
    implementation("com.github.JustinFreitas.lavaplayer:lavaplayer:v2.2.6_20")
    implementation("com.github.JustinFreitas.lavaplayer:lavaplayer-ext-format-xm:v2.2.6_20")
    implementation("com.github.JustinFreitas.lavaplayer:lavaplayer-ext-youtube-rotator:v2.2.6_20")
